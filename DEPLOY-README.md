...
- **源文件**：`privacy-policy-googleplay-en.html`
...
1. 在本地修改 `privacy-policy-googleplay-en.html`（如更新日期、条款内容）。
2. 在项目根目录执行：
   ```bash
   ./deploy-privacy-to-ec2.sh
   ```
...
| `PRIVACY_HTML` | 本地协议 HTML 路径 | 当前目录下 `privacy-policy-googleplay-en.html` |
